...
def build() -> None:
    ...
    east_terminal_support_lower = create_collision_box(
        name="C_REV2__ARCHIVE_EAST_TERMINAL_SUPPORT_LOWER",
        center_seed_mm=(23_800, 5_175, 14_400),
        dimensions_mm=(5_200, 800, 250),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_terminal_support",
        source_id="archive_east_terminal_support_lower",
        reason="stage_terminal_approach_before_5650_support_with_maximum_350_mm_rises",
    )
    east_terminal_support_lower["kyx_support_top_mm"] = 5_300
    east_terminal_support_lower["kyx_maximum_resulting_step_mm"] = 350

    east_terminal_support_upper = create_collision_box(
        name="C_REV2__ARCHIVE_EAST_TERMINAL_SUPPORT_UPPER",
        center_seed_mm=(23_800, 5_475, 14_600),
        dimensions_mm=(5_200, 400, 350),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_terminal_support",
        source_id="archive_east_terminal_support_upper",
        reason="split_terminal_transition_into_350_mm_upper_support_and_node_rises",
    )
    east_terminal_support_upper["kyx_support_top_mm"] = 5_650
    east_terminal_support_upper["kyx_maximum_resulting_step_mm"] = 350

    west_terminal_support_lower = create_collision_box(
        name="C_REV2__ARCHIVE_WEST_TERMINAL_SUPPORT_LOWER",
        center_seed_mm=(-23_800, 5_175, 14_400),
        dimensions_mm=(5_200, 800, 250),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_terminal_support",
        source_id="archive_west_terminal_support_lower",
        reason="stage_terminal_approach_before_5650_support_with_maximum_350_mm_rises",
    )
    west_terminal_support_lower["kyx_support_top_mm"] = 5_300
    west_terminal_support_lower["kyx_maximum_resulting_step_mm"] = 350

    west_terminal_support_upper = create_collision_box(
        name="C_REV2__ARCHIVE_WEST_TERMINAL_SUPPORT_UPPER",
        center_seed_mm=(-23_800, 5_475, 14_600),
        dimensions_mm=(5_200, 400, 350),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_terminal_support",
        source_id="archive_west_terminal_support_upper",
        reason="split_terminal_transition_into_350_mm_upper_support_and_node_rises",
    )
    west_terminal_support_upper["kyx_support_top_mm"] = 5_650
    west_terminal_support_upper["kyx_maximum_resulting_step_mm"] = 350

    archive_drop_landing_runout = create_collision_box(
        name="C_REV2__ARCHIVE_DROP_PRESS_NORTH__LANDING_RUNOUT",
        center_seed_mm=(-3_000, -125, 9_200),
        dimensions_mm=(4_400, 2_000, 250),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_drop_landing_runout",
        source_id="archive_drop_press_north",
        reason="extend_press_north_landing_under_measured_one_way_drop_corridor",
    )
    archive_drop_landing_runout["kyx_support_top_mm"] = 0
    archive_drop_landing_runout["kyx_landing_width_mm"] = 4_400
    archive_drop_landing_runout["kyx_runout_extension_mm"] = 2_000
    archive_drop_landing_runout["kyx_drop_height_mm"] = 6_000
    archive_drop_landing_runout["kyx_preserves_one_way_drop"] = True

    archive_drop_launch_extension = create_collision_box(
        name="C_REV2__ARCHIVE_DROP__LAUNCH_EXTENSION",
        center_seed_mm=(-5_000, 5_875, 8_100),
        dimensions_mm=(3_200, 600, 250),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_drop_launch_runout",
        source_id="archive_drop_press_north",
        reason="extend_archive_drop_launch_to_pinned_intermediate_waypoint_z_plane",
    )
    archive_drop_launch_extension["kyx_support_top_mm"] = 6_000
    archive_drop_launch_extension["kyx_launch_extension_mm"] = 600
    archive_drop_launch_extension["kyx_preserves_one_way_drop"] = True
    ...
    report = {
        ...
        "collisionCorrection": {
            ...
            "eastTerminalSupport": {
                "parts": [
                    {
                        "id": east_terminal_support_lower.name,
                        "centerSeedMm": [23_800, 5_175, 14_400],
                        "dimensionsLocalMm": [5_200, 800, 250],
                        "supportTopMm": 5_300,
                    },
                    {
                        "id": east_terminal_support_upper.name,
                        "centerSeedMm": [23_800, 5_475, 14_600],
                        "dimensionsLocalMm": [5_200, 400, 350],
                        "supportTopMm": 5_650,
                    },
                ],
                "measuredIncomingFootMm": 5_350,
                "archiveNodeTopMm": 6_000,
                "maximumResultingRiseMm": 350,
            },
            "westTerminalSupport": {
                "parts": [
                    {
                        "id": west_terminal_support_lower.name,
                        "centerSeedMm": [-23_800, 5_175, 14_400],
                        "dimensionsLocalMm": [5_200, 800, 250],
                        "supportTopMm": 5_300,
                    },
                    {
                        "id": west_terminal_support_upper.name,
                        "centerSeedMm": [-23_800, 5_475, 14_600],
                        "dimensionsLocalMm": [5_200, 400, 350],
                        "supportTopMm": 5_650,
                    },
            ...
            "archiveDropPressNorthLandingRunout": {
                "id": archive_drop_landing_runout.name,
                "centerSeedMm": [-3_000, -125, 9_200],
                "dimensionsLocalMm": [4_400, 2_000, 250],
                "supportTopMm": 0,
                "landingWidthMm": 4_400,
                "minimumAuthoredLandingWidthMm": 4_000,
                "runoutExtensionMm": 2_000,
                "dropHeightMm": 6_000,
                "oneWayDropPreserved": True,
                "mirroredCounterpartAdded": False,
                "mirrorReason": "topology_defines_no_corresponding_authored_drop_link",
            },
            "archiveDropLaunchExtension": {
                "id": archive_drop_launch_extension.name,
                "centerSeedMm": [-5_000, 5_875, 8_100],
                "dimensionsLocalMm": [3_200, 600, 250],
                "supportTopMm": 6_000,
                "launchExtensionMm": 600,
                "existingArchiveDropFrontZMm": 8_400,
                "candidateLaunchFrontZMm": 7_800,
                "pinnedIntermediateWaypointMm": [-4_000, 2_500, 8_000],
                "oneWayDropPreserved": True,
            },
            "teleport": {
                "exitRouteCollider": {
