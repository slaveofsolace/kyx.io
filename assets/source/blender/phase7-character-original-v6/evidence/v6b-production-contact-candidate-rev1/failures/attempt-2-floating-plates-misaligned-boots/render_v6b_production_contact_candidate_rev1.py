...
def configure_scene() -> bpy.types.Scene:
    ...
    base.add_area(f"{RENDER_PREFIX}HelmetRim", (-1.6, 0.8, 3.1), 950.0, 1.5, (0.26, 0.62, 1.0), target)
    base.add_area(f"{RENDER_PREFIX}LowFill", (2.0, -2.4, 0.65), 520.0, 1.6, (1.0, 0.34, 0.16), Vector((0.0, -0.25, 0.70)))
    return scene
...
def main() -> None:
    ...
    panels.append(render_view(
        ...
        weapon_scope="stock", transparent_material=PREFIX + "ContactRubber",
    ))
