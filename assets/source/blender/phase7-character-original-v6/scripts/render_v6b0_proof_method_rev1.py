...
EVIDENCE = BASE / "evidence" / "v6b0-proof-method-rev1"
...
def configure() -> bpy.types.Scene:
    ...
    bpy.ops.mesh.primitive_plane_add(size=8.0, location=(0.0, 0.75, 2.5), rotation=(math.radians(90), 0.0, 0.0))
    backdrop = bpy.context.object
    backdrop.name = "V6B0_RENDER_Backdrop"
    backdrop.data.materials.append(stage_mat)

    target = (-0.08, -0.08, 1.23)
    add_area("V6B0_RENDER_Key", (-2.4, -3.4, 3.0), 780.0, (0.78, 0.88, 1.0), 2.8, target)
    add_area("V6B0_RENDER_Fill", (2.5, -2.5, 2.1), 520.0, (1.0, 0.71, 0.52), 2.4, target)
    add_area("V6B0_RENDER_Rim", (1.2, 1.1, 2.8), 1050.0, (0.12, 0.48, 1.0), 1.8, target)
    add_area("V6B0_RENDER_WeaponEdge", (-1.6, -1.0, 1.5), 410.0, (0.26, 0.72, 1.0), 1.0, (-0.25, -0.30, 1.15))
    add_area("V6B0_RENDER_ChestSoftbox", (0.1, -2.3, 2.6), 380.0, (1.0, 0.95, 0.84), 1.6, (0.1, -0.05, 1.36))
    return scene


def main() -> None:
    if "v6b0_proof_method_rev1" not in Path(bpy.data.filepath).name:
    ...
    records = [
        render_view(scene, cameras["front"], "kyx-v6b0-proof-method-rev1-front.png"),
        render_view(scene, cameras["three_quarter"], "kyx-v6b0-proof-method-rev1-three-quarter.png"),
        render_view(scene, cameras["right_side"], "kyx-v6b0-proof-method-rev1-right-side.png"),
        render_view(scene, cameras["contact"], "kyx-v6b0-proof-method-rev1-contact-close.png"),
        render_view(scene, cameras["armor_close"], "kyx-v6b0-proof-method-rev1-armor-close.png"),
    ]
    report = {
        "checkpoint": "V6-B0 proof-of-method rev1",
