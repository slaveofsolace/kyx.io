...
export const validClientMessages = [
  ...
  },
  {
    protocolVersion: PROTOCOL_VERSION,
    type: 'joinSpectator',
    requestId: 'req.spectator.join.1',
    roomCode: 'practice-01',
  ...
  },
  {
    ...
    requestId: 'req.spectator.resume.1',
    roomCode: 'practice-01',
    resumeToken,
  },
  {
    ...
    requestId: 'req.spectator.target.1',
    targetPlayerId: 'player.1',
  },
  {
    protocolVersion: PROTOCOL_VERSION,
    type: 'rematchVote',
    requestId: 'req.rematch.1',
    decision: 'accept',
  },
...
export const validServerMessages = [
  ...
  },
  {
    ...
    targetRevision: 1,
    targets: [
      { playerId: 'player.1', connected: true, lifePhase: 'alive' },
      { playerId: 'player.2', connected: false, lifePhase: 'dead' },
    ],
  },
  {
    protocolVersion: PROTOCOL_VERSION,
    ...
    votes: [
      { playerId: 'player.1', decision: 'accept', authorityTick: 102 },
    ],
  },
