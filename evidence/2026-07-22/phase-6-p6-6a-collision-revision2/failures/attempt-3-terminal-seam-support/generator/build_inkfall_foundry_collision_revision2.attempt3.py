...
def build() -> None:
    ...
    east_terminal_support = create_collision_box(
        name="C_REV2__ARCHIVE_EAST_TERMINAL_SUPPORT",
        center_seed_mm=(22_000, 5_500, 15_400),
        dimensions_mm=(4_400, 2_000, 300),
    ...
    east_terminal_support["kyx_support_top_mm"] = 5_650
    east_terminal_support["kyx_maximum_resulting_step_mm"] = 350

    west_terminal_support = create_collision_box(
        name="C_REV2__ARCHIVE_WEST_TERMINAL_SUPPORT",
        center_seed_mm=(-22_000, 5_500, 15_400),
        dimensions_mm=(4_400, 2_000, 300),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_terminal_support",
        source_id="archive_west_terminal_support",
        reason="split_observed_5350_to_6000_terminal_rise_into_300_and_350_mm_steps",
    )
    west_terminal_support["kyx_support_top_mm"] = 5_650
    west_terminal_support["kyx_maximum_resulting_step_mm"] = 350
    ...
    report = {
        ...
        "collisionCorrection": {
            ...
            "eastTerminalSupport": {
                "id": east_terminal_support.name,
                "centerSeedMm": [22_000, 5_500, 15_400],
                "dimensionsLocalMm": [4_400, 2_000, 300],
                "supportTopMm": 5_650,
