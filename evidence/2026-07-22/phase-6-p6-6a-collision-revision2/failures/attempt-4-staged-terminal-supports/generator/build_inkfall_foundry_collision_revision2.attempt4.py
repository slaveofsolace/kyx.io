...
def build() -> None:
    ...
    east_terminal_support_lower = create_collision_box(
        ...
        center_seed_mm=(22_000, 5_175, 14_400),
        dimensions_mm=(4_400, 800, 250),
    ...
    east_terminal_support_upper = create_collision_box(
        ...
        center_seed_mm=(22_000, 5_475, 14_600),
        dimensions_mm=(4_400, 400, 350),
        collection=collision_collection,
        material=collision_material,
        source_kind="bounded_authority_terminal_support",
                ...
                "parts": [
                    {
                        ...
                        "centerSeedMm": [22_000, 5_175, 14_400],
                        "dimensionsLocalMm": [4_400, 800, 250],
                        "supportTopMm": 5_300,
                    },
                    {
                        "id": east_terminal_support_upper.name,
                        "centerSeedMm": [22_000, 5_475, 14_600],
                        "dimensionsLocalMm": [4_400, 400, 350],
                        "supportTopMm": 5_650,
                    },
                ],
