...
def build() -> None:
    ...
    terminal_support = create_collision_box(
        ...
        center_seed_mm=(22_000, 5_500, 14_300),
        dimensions_mm=(2_800, 1_800, 300),
    ...
    report = {
        ...
        "collisionCorrection": {
            ...
            "eastTerminalSupport": {
                ...
                "centerSeedMm": [22_000, 5_500, 14_300],
                "dimensionsLocalMm": [2_800, 1_800, 300],
                "supportTopMm": 5_650,
            ...
            "teleport": {
                ...
                "landingNodeGeometryChanged": False,
            },
        },
        "preserved": {
