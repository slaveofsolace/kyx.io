...
def build() -> None:
    ...
    archive_drop_launch_extension = create_collision_box(
        ...
        center_seed_mm=(-5_000, 5_875, 8_200),
        dimensions_mm=(3_200, 400, 250),
        collection=collision_collection,
        material=collision_material,
    ...
    archive_drop_launch_extension["kyx_launch_extension_mm"] = 400
    ...
    report = {
        ...
        "collisionCorrection": {
            ...
            "archiveDropLaunchExtension": {
                ...
                "centerSeedMm": [-5_000, 5_875, 8_200],
                "dimensionsLocalMm": [3_200, 400, 250],
                "supportTopMm": 6_000,
                "launchExtensionMm": 400,
                "existingArchiveDropFrontZMm": 8_400,
                "candidateLaunchFrontZMm": 8_000,
