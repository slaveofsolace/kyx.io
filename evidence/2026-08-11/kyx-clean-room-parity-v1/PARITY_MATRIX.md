...
Working gate for product source `f8e8746761a0c1a2788dd3185b3aa6677590e4eb` on 2026-08-12. Statuses describe the canonical product paths, not isolated fixtures or review routes.
...
| Map breadth and rotation | PARTIAL | Relay, Switchyard and Crownpoint are original source-defined authority fixtures with distinct spawns, collision, elevation, landmarks, bot profiles and fixture-bound renderers. Installed Chrome proves all renderers and deterministic fresh-room rotation. | Human Eye/traversal/combat acceptance on each map and remote staging proof. |
