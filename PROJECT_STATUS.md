...
| Inkfall Foundry | Rev5 render-art review candidate over the frozen Revision 3 authority package: 339 colliders, 12 spawns, and 9 zones. Bridge and landing grounding are corrected; the portal field and broader environment art remain non-release | Replace the flat portal field and graybox material/void treatment as one environment-art pass, then capture player-eye evidence and complete manual collision/sightline/spawn/play review |
