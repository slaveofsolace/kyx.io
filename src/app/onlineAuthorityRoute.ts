...
async function mountSession(
  ...
  arenaHead.append(element(
    ...
    '',
    inkfallRev4
      ? `Click for mouse look · WASD · ${selectedCombatPreset.roleLabel} + blade · M1 fire · R reload · E/F/Z abilities · Q Blink`
      : 'WASD · Shift sprint · Space jump · M1 fire · R reload · E/F/Z abilities · Q Blink',
  ));
